...
var play = function()
{
	...
	if( !pla1 || pla1.closed ) pla1 = window.open( "", "Player1", "top="+ py +",left="+ px +",width="+ w +",height="+ h +",location=no,menubar=no,scrollbars=no,status=no,toolbar=no" );
	if( !pla2 || pla2.closed ) pla2 = window.open( "", "Player2", "top="+ py +",left="+ px +",width="+ w +",height="+ h +",location=no,menubar=no,scrollbars=no,status=no,toolbar=no" );

	var bx = Math.round( screen.width  / 2 - unit / 2 );
	var by = Math.round( screen.height / 2 - unit / 2 );
	if( !ball || ball.closed ) ball = window.open( "", "Ball", "top="+ by +",left="+ bx +",width="+ unit +",height="+ unit +",location=no,menubar=no,scrollbars=no,status=no,toolbar=no" );
